...
METADATA_FIELDS = {
    ...
    'colors': {
        'type': 'string_array',
        'description': 'A list of all the colors in manaCost and colorIndicator properties. Cards with `Devoid` will have no color',
        'filterable': True,
        'display_name': 'Colors'
    },
    'manaCost': {
        'type': 'string',
        'description': 'Mana cost in symbols, relevant for normal or split cards',
        'filterable': True,
