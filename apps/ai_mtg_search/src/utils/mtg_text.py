...
║                                                                           ║
║ Source : mtg-db @ 28bbd03, utils/mtg_text.py (last changed 532d52c)       ║
║ md5    : 13849e2496aacc1d333b91267df08590                                 ║
║ Copied : 2026-08-22                                                       ║
║                                                                           ║
║ Document vectors in Neon were produced with this exact code. If the two   ║
║ copies drift, query and document vectors stop being comparable and        ║
║ retrieval degrades silently — there is no error to catch. Re-copy from    ║
║ mtg-db rather than patching, and re-run the parity check in               ║
║ scripts/check_embedding_parity.py afterwards.                             ║
╚═══════════════════════════════════════════════════════════════════════════╝
