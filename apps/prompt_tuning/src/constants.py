DESCRIPTION = """
## About this App
This app demonstrates a semi-supervised method to tune and optimize an LLM prompt inspired by neural network training, leveraging LLM-as-a-Judge for to calculate "loss", and LLM-as-a-Judge as our "optimizer".
...
Because we understand LLMs can and will hallucinate, and that they are actually trained to "complete" their thoughts rather than truly predict, you may be tempted to dismiss the affectiveness of this method... but consider the practically of this at scale! We can't, and shouldn't eliminate human-in-the-loop, but even a few turns through this process can likely yield a more effective prompt than what you initially started with.
